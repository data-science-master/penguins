...
This is a simple exercise for creating a makefile to manager a small project that examines the really cool [Palmer Penguins data](https://allisonhorst.github.io/palmerpenguins/).
...
library(ggdag)
set.seed(15)
dagify("penguin_pairs.pdf" ~ "plot_penguin.R",
       "penguin_class.csv" ~ "classify_penguins.R",
       "penguin_report.html" ~ "penguin_pairs.pdf",
